...
const ProfileHero = () => {
  ...
  return (
    <div
      className="flex w-4/5 bg-[#1A365D] min-h-2/5 text-blue-50 mt-4 m-auto rounded-2xl"
    ...
    >
      ...
      <div className="w-3/5 flex flex-col justify-between gap-3 align-middle ">
        <button className="place-items-end border-[#0067B3]  border-2 w-2/5 self-end rounded-xl hover:bg-[#ccefff] hover:text-[#353434] transistion duration-200 p-1 font-bold">
          Download Resume
        </button>
        <div>
